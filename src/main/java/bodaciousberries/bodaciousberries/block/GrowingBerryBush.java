...
public class GrowingBerryBush extends BasicBerryBush {
    ...
    public GrowingBerryBush(Settings settings, VoxelShape smallShape, VoxelShape largeShape, int sizeChangeAge, DamageSourceTwoElectricBoogaloo damageSource, DoubleBerryBush bush) {
        super(settings, bush.getBerryType(), bush.getUnripeBerryType(), bush.getMaxBerryAge(), smallShape, largeShape, sizeChangeAge, damageSource);
