...
public class BodaciousBlocks {
    ...
    public static final RegistryKey<Block> BERRY_HARVESTER_KEY = RegistryKey.of(RegistryKeys.BLOCK, BERRY_HARVESTER);
    public static final BerryHarvesterBlock BERRY_HARVESTER_BLOCK = new BerryHarvesterBlock(AbstractBlock.Settings.create().key(BERRY_HARVESTER_KEY).sounds(BlockSoundGroup.COPPER).strength(4.0f));
    public static final BlockEntityType<BerryHarvesterBlockEntity> BERRY_HARVESTER_ENTITY = FabricBlockEntityTypeBuilder.create(BerryHarvesterBlockEntity::new, BERRY_HARVESTER_BLOCK).build();
    ...
    public static final RegistryKey<Block> JUICER_KEY = RegistryKey.of(RegistryKeys.BLOCK, JUICER);
    public static final JuicerBlock JUICER_BLOCK = new JuicerBlock(AbstractBlock.Settings.create().key(JUICER_KEY).sounds(BlockSoundGroup.COPPER).strength(4.0f));
    public static final BlockEntityType<JuicerBlockEntity> JUICER_ENTITY = FabricBlockEntityTypeBuilder.create(JuicerBlockEntity::new, JUICER_BLOCK).build();
