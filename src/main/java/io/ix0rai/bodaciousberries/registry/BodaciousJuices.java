...
public class BodaciousJuices {
    ...
    public static void register() {
        register(io.ix0rai.bodaciousberries.BodaciousBerries.id("dubious_juice"), DUBIOUS_JUICE);
        register("saskatoon_berry_juice", new Juice(BodaciousItems.saskatoonBerries, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.more_purple")));
        ...
        register("blackberry_juice", new Juice(BodaciousItems.blackberries, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.blackberries_and_sweetness")));
        register("rainberry_juice", new Juice(BodaciousItems.rainberries));
        register("lingonberry_juice", new Juice(BodaciousItems.lingonberries, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.more_red")));
        register("grape_juice", new Juice(BodaciousItems.grapes));
        register("goji_berry_juice", new Juice(BodaciousItems.gojiBerries, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.sweetness")));
        register("gooseberry_juice", new Juice(BodaciousItems.gooseberries, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.red_and_yellow")));
        ...
        register("sweet_berry_juice", new Juice(Items.SWEET_BERRIES, io.ix0rai.bodaciousberries.BodaciousBerries.translatableText("hint.vanilla")));
    ...
    private static void createBiomeChorusJuice() {
        ...
        for (int i = 0; i < biomes.length; i++) {
            ...
            Identifier id = io.ix0rai.bodaciousberries.BodaciousBerries.id("chorus_berry_juice_" + key.getValue().getPath());
    ...
    private static void register(String name, Juice juice) {
        Identifier id = io.ix0rai.bodaciousberries.BodaciousBerries.id(name);
